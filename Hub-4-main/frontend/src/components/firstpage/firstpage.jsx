...
import blogo from "../img/logo01.gif";
        ...
        <div className="containerStyle">
          ...
          <div className="groupedSectionStyle">
            <div className="newBox">
              <div className="tex">
                Schedule & Employee Management with
                <span className="textbox"> ScheduleHub</span>
              </div>
              <div className="otherStyle">
               

                Efficiently manage your employees and schedules with ShiftMaster. Our platform offers an all-in-one solution to streamline your workforce management. Whether you're a small business or a large enterprise,Keep all your employee information organized and up-to-date. 
